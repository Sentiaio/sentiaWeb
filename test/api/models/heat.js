        ...
        describe('OK', function () {
            ...
            before(function() {
                attrs = {
                    ...
                    cam : '537d1feed77160444dd488a6',
                    company : '53731f7d6f72bb297bcd71fd',
                    time : new Date().getTime()

                };
                next = sinon.spy();
                app.models.heat.beforeCreate(attrs, next);
            });
            after(function () {});
            ...
            it('should convert cam to a matching objectId', function () {
                attrs.cam.should.have.property('_bsontype');
                attrs.cam.toString().should.equal('537d1feed77160444dd488a6');
            });
