...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="page container-fluid p-top animate-scale padding-xs-none">\n    <div class="container-fluid padding-xs-none">\n\n        <div id="camera-details" class="widget widget-white">\n            <div class="container-fluid p-bottom p-top padding-xs-none">\n<!--                 <div class="container-fluid padding-xs-none">\n                    <h3 id="camera-details-title" class="caps"></h3>\n                </div>\n -->                <div class="col-sm-9 padding-xs-none">\n                    <div id="camera-shot" class="map-container">\n                        <img ng-src="/images/cameras/{{cam}}.png" alt="" class="header-image">\n                        <s-heatmap data="heatmap" ng-show="heatmap"></s-heatmap>\n                        <s-flowmap data="flowmap" ng-show="flowmap"></s-flowmap>\n                    </div>\n                    <div class="container-fluid">\n                        <div class="row">\n                            <ul id="camera-timeline" class="timeline">\n                                <li ng-repeat="value in timeline.data track by $index" class="timeline-item" tooltip="{{$index}}:00" tooltip-append-to-body="true" tooltip-placement="bottom" ng-click="mapQuery.hour = $index" ng-class="{active: mapQuery.hour === $index}">\n                                    <div class="timeline-bar" style="height: {{((value / timeline.max) *100) + \'%\'}}" ></div>\n                                </li>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n                <div class="col-sm-3">\n                    <div id="camera-control" class="row clearfix" role="form">\n                        <div class="container-fluid">\n                            <div class="well">\n\n                                <div class="form-group text-center">\n                                <input type="radio" name="mapType" ng-model="mapQuery.type" value="heat" id ="cam-maptype-heat">\n                                    <label class="radio-inline" for="cam-maptype-heat">Heatmap</label>\n                                <input type="radio" name="mapType" ng-model="mapQuery.type" value="flow" id ="cam-maptype-flow">\n                                    <label class="radio-inline"  for="cam-maptype-flow">Flowmap</label>\n                                </div>\n                                <div class="form-group">\n                                    <datepicker class="datepicker" show-weeks="false" ng-model="mapQuery.date"></datepicker>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n\n';
...
this["JST"]["assets/views/store.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="page container-fluid container-swipe">\n    <div class="row">\n        <div id="camera-list" class="container scroll scroll-y p-top p-bottom">\n            <div class="container-fluid">\n                <input type="text" id="camera-list-search" class="form-control" role="search" ng-model="camSearch">\n            </div>\n            <ul class="list list-widgets row">\n                <li ng-repeat="cam in cameras | filter : camSearch | orderBy : \'name\'" ng-click="$parent.selectedCam = cam" ng-class="{active: selectedCam.id === cam.id}" class="col-md-4 col-sm-6 animate-fade">\n                <a href="#/store/camera/{{cam.id}}">\n                    <div class="widget widget-white a widget-content gutter-top">\n                        <div style="height :195px; overflow: hidden;">\n                            <img ng-src="/images/cameras/{{cam.id}}.png" alt="" class="header-image">\n                        </div>\n                        <h5 class="searchable caps" ng-bind-html="\'{{cam.name}}\' | highlight:camSearch:false"></h5>\n                    </div>\n                </a>\n                </li>\n            </ul>\n        </div>\n    </div>\n</div>';
